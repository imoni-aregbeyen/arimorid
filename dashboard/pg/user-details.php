...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_user'])) {
        ...
        $sql = "UPDATE users SET name='$name', email='$email', phone='$phone', role='$role', verified='$verified', dob='$dob', address='$address', id_type='$id_type', id_number='$id_number', account_number='$account_number', bank_name='$bank_name', account_name='$account_name', emgc_name='$emgc_name', emgc_address='$emgc_address', emgc_phone='$emgc_phone', emgc_email='$emgc_email', emgc_relationship='$emgc_relationship' WHERE id=$id";
        if ($conn->query($sql)) {
